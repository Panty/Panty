<?php /* Smarty version Smarty-3.1.13, created on 2013-07-08 01:55:03
         compiled from "C:\xampp\htdocs\Panty\system\smarty\templates\ragefull\cgu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:879351d9e93fb04326-33501773%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7199deaa6b82fd6370900d43dae6b7dd81733f9a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Panty\\system\\smarty\\templates\\ragefull\\cgu.tpl',
      1 => 1373236013,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '879351d9e93fb04326-33501773',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_51d9e93fbefca8_99305449',
  'variables' => 
  array (
    'THEME' => 0,
    'TITLE' => 0,
...
<?php if ($_valid && !is_callable('content_51d9e93fbefca8_99305449')) {function content_51d9e93fbefca8_99305449($_smarty_tpl) {?><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
	<head>
...
devtool/help.png"> Qui contacter et comment ?</h2>
	<div class="news-text">
...
<li class="news-row">
	<h2><img width="16" height="16" style="float: left;" src="<?php echo $_smarty_tpl->tpl_vars['URL_ASSETS_GLOBAL']->value;?>
devtool/money.png"> Transactions :</h2>
	<div class="news-text">
...
<li class="news-row">
	<h2><img width="16" height="16" style="float: left;" src="<?php echo $_smarty_tpl->tpl_vars['URL_ASSETS_GLOBAL']->value;?>
devtool/user.png"> Pseudonymes :</h2>
	<div class="news-text">
...
<li class="news-row">
	<h2><img width="16" height="16" style="float: left;" src="<?php echo $_smarty_tpl->tpl_vars['URL_ASSETS_GLOBAL']->value;?>
devtool/newspaper.png"> Charte en jeu :</h2>
	<div class="news-text">
...
<li class="news-row">
	<h2><img width="16" height="16" style="float: left;" src="<?php echo $_smarty_tpl->tpl_vars['URL_ASSETS_GLOBAL']->value;?>
devtool/set_security_question.png"> Guildes :</h2>
	<div class="news-text">
...
<li class="news-row">
	<h2><img width="16" height="16" style="float: left;" src="<?php echo $_smarty_tpl->tpl_vars['URL_ASSETS_GLOBAL']->value;?>
devtool/comment.png"> Canaux de discussions :</h2>
	<div class="news-text">
